...
class TMVPiJuice(PiJuice):
    ...
    def __init__(self, led='D2', lum=64):
        self.led = led
        self.lum = lum
        super().__init__()
    ...
    def power_off(self):
        ...
        sleep(60)
        pj_check(self.power.SetPowerOff(60))
    ...
    def wakeup_enable(self, wakeup):
        ...
        wake_time_dict = {'second': utc_time.second,
                          ...
                          'hour': utc_time.hour,
                          'day': "EVERY_DAY"}
        pj_check(self.rtcAlarm.SetWakeupEnabled(True))
        pj_check(self.rtcAlarm.SetAlarm(wake_time_dict))
    ...
    def wakeup_disable(self):
        self.pj_check(self.rtcAlarm.SetWakeupEnabled(False))
